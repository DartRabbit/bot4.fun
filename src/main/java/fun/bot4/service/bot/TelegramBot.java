package fun.bot4.service.bot;

import static fun.bot4.util.telegram.TextFormatUtils.bold;
import static fun.bot4.util.telegram.TextFormatUtils.code;
import static fun.bot4.util.telegram.TextFormatUtils.italic;
import static fun.bot4.util.telegram.TextFormatUtils.userLink;
...
//    HttpHost httpHost = new HttpHost("212.237.22.171", 3128, "https");
//    RequestConfig requestConfig = RequestConfig.custom().setProxy(httpHost).setAuthenticationEnabled(false).build();
//    this.getOptions().setRequestConfig(requestConfig);
//    this.getOptions().setHttpProxy(httpHost);
  ...
  public ReplyKeyboard getKeyboardMarkUp(boolean getKeyboard) {
